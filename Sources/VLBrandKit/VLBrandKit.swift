...
public extension VLstack
{
 enum Brand
 {
  public enum Logo
  {
   public static let main = Image("logo", bundle: .module)
   public static let alternate = Image("logo-alternate", bundle: .module)
   public static let white = Image("logo-white", bundle: .module)
  }
